...
<div class="p1 row justify-center">
  ...
  <a class="show p05 color-black-50" href="<?= Eyca\link_to([ 'pageno' => NULL ], TRUE) ?>">1</a>
  ...
  <span class="show p05 color-black-20">&hellip;</span>
  <a class="show p05 color-black-50" href="<?= Eyca\link_to([ 'pageno' => $data['paginate']['pages'] ], TRUE) ?>"><?= $data['paginate']['pages'] ?></a>
  <?php endif ?>
  <?php /* next */ ?>
  <?php if ($data['paginate']['pageno'] + 1 < $data['paginate']['pages']): ?>
  <a class="show p05 color-black-50" href="<?= Eyca\link_to([ 'pageno' => $data['paginate']['pageno'] + 2 ], TRUE) ?>">&gt;</a>
  <?php endif ?>
</div>
<?php endif ?>
